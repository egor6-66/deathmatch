...
class PBR {
    ...
    async createBarrel() {
        // SceneLoader.ImportMesh('', '/assets/images/models/', 'barrel_01_4k.glb', this.scene, (m) => {
        //     console.log('meshes', m);
        // });
        const models = await SceneLoader.ImportMeshAsync('', '/assets/images/models/', 'barrel_01_4k.glb');
    }
}
